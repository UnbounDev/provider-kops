...
func (in *KopsClusterSpec) DeepCopyInto(out *KopsClusterSpec) {
	*out = *in
	...
	in.NodeProblemDetector.DeepCopyInto(&out.NodeProblemDetector)
	in.NodeTerminationHandler.DeepCopyInto(&out.NodeTerminationHandler)
	...
	if in.ServiceAccountIssuerDiscovery != nil {
		...
		*out = new(ServiceAccountIssuerDiscoverySpec)
		(*in).DeepCopyInto(*out)
	}
	...
	in.KubeDNS.DeepCopyInto(&out.KubeDNS)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceAccountIssuerDiscoverySpec) DeepCopyInto(out *ServiceAccountIssuerDiscoverySpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceAccountIssuerDiscoverySpec.
func (in *ServiceAccountIssuerDiscoverySpec) DeepCopy() *ServiceAccountIssuerDiscoverySpec {
	if in == nil {
		return nil
	}
	out := new(ServiceAccountIssuerDiscoverySpec)
